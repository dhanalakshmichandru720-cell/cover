...
<head>
    ...
    <title>Book Cover - DHANALAKSHMI C</title>
    <style>
    ...
    <div class="book-cover">
        ...
        <div class="footer">
            <div class="footer-text">
                ...
                <p class="author-name">MS. DHANALAKSHMI C</p>
            </div>
            <div class="author-photo">
                <img src="photo.jpg" alt="DHANALAKSHMI C">
            </div>
        </div>
    </div>
...
<img width="701" height="848" alt="Screenshot 2025-12-25 103402" src="https://github.com/user-attachments/assets/e3fe5eae-a984-4df8-8972-d1d6fbe3c914" />
